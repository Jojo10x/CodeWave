/* Модуль constants.js определяет константы, которые используются в различных частях программы. */

/* Константы CREATE_CODE и DEFAULT_ERROR_CODE определяют коды ответов сервера, которые используются при создании новых объектов и обработке ошибок. */
